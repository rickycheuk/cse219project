...
import jcd.ui.AppYesNoCancelDialogSingleton;
import jcd.ui.AppMessageDialogSingleton;
import jcd.ui.AppGUI;
import jcd.components.AppFileComponent;
import jcd.components.AppDataComponent;
import java.io.File;
...
import static jcd.settings.AppPropertyType.LOAD_ERROR_MESSAGE;
import static jcd.settings.AppPropertyType.LOAD_ERROR_TITLE;
import static jcd.settings.AppPropertyType.LOAD_WORK_TITLE;
import static jcd.settings.AppPropertyType.WORK_FILE_EXT;
import static jcd.settings.AppPropertyType.WORK_FILE_EXT_DESC;
import static jcd.settings.AppPropertyType.NEW_COMPLETED_MESSAGE;
import static jcd.settings.AppPropertyType.NEW_COMPLETED_TITLE;
import static jcd.settings.AppPropertyType.NEW_ERROR_MESSAGE;
import static jcd.settings.AppPropertyType.NEW_ERROR_TITLE;
import static jcd.settings.AppPropertyType.SAVE_COMPLETED_MESSAGE;
import static jcd.settings.AppPropertyType.SAVE_COMPLETED_TITLE;
import static jcd.settings.AppPropertyType.SAVE_ERROR_MESSAGE;
import static jcd.settings.AppPropertyType.SAVE_ERROR_TITLE;
import static jcd.settings.AppPropertyType.SAVE_UNSAVED_WORK_MESSAGE;
import static jcd.settings.AppPropertyType.SAVE_UNSAVED_WORK_TITLE;
import static jcd.settings.AppPropertyType.SAVE_WORK_TITLE;
import static jcd.settings.AppStartupConstants.PATH_WORK;
