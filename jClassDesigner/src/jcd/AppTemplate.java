...
import jcd.components.AppComponentsBuilder;
import java.net.URL;
import javafx.application.Application;
import javafx.stage.Stage;
import properties_manager.PropertiesManager;
import static jcd.settings.AppPropertyType.APP_CSS;
import static jcd.settings.AppPropertyType.APP_PATH_CSS;
import static jcd.settings.AppPropertyType.APP_TITLE;
import static jcd.settings.AppPropertyType.PROPERTIES_LOAD_ERROR_MESSAGE;
import static jcd.settings.AppPropertyType.PROPERTIES_LOAD_ERROR_TITLE;
import static jcd.settings.AppStartupConstants.PATH_DATA;
import static jcd.settings.AppStartupConstants.PROPERTIES_SCHEMA_FILE_NAME;
import static jcd.settings.AppStartupConstants.SIMPLE_APP_PROPERTIES_FILE_NAME;
import static jcd.settings.AppStartupConstants.WORKSPACE_PROPERTIES_FILE_NAME;
